...
def main():
    """Объединяет Excel файлы в CSV - версия 2 для новых данных"""
    ...
    if all_data:
        ...
        # Сохраняем
        result.to_csv('combined_meteo_data_v2.csv', index=False, encoding='utf-8-sig')
